...
Loading and running genuine CP/M COM binaries fetched over the wire — the pillar-1 payoff: the server ships real bytes, the local CPU executes them (PRD §8, ADR-0001).
